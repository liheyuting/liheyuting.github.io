function init(w, d) {
    ...
    var Blog = {
        goTop: function goTop(end) {
            ...
            if (top && top > end) {
                ...
                animate(goTop.bind(this, end, interval));
            } else if (end && top < end) {
        ...
        toggleMenu: function (flag) {
            ...
            if (flag) {
                ...
                headerTitle.classList.add('header-padding');
                ...
                headerTitle.classList.remove('header-padding');
    ...
    if (w.Waves) {
        w.Waves.init();
        w.Waves.attach('.global-share li', ['waves-block']);
        w.Waves.attach('.article-tag-list-link, #page-nav a, #page-nav span', ['waves-button']);
    } else {
